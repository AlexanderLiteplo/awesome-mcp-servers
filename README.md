...
- <img src="https://rentahuman.ai/favicon.ico" height="14"/> [RentAHuman](https://github.com/alexliteplo/rentahuman-mcp) - MCP server for AI agents to hire humans for physical-world tasks on [rentahuman.ai](https://rentahuman.ai). 60+ tools for searching 500K+ humans, posting bounties, managing escrow payments, conversations, and webhooks. Install via `npx rentahuman-mcp`.
